.class public Lcom/mobile/indiapp/n/ba;
...
.method public static a(Landroid/content/Context;ILcom/mobile/indiapp/k/b$a;Z)Lcom/mobile/indiapp/n/ba;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string/jumbo v2, "/sticker.specials"
    ...
    new-instance v1, Lcom/mobile/indiapp/n/ba;

    invoke-direct {v1, v0}, Lcom/mobile/indiapp/n/ba;-><init>(Lcom/mobile/indiapp/k/a$a;)V
...
.method protected a(Lb/z;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/mobile/indiapp/n/ba;->b:Lcom/google/gson/JsonParser;
    ...
    const-string/jumbo v0, "specials"

    invoke-virtual {v1, v0}, Lcom/google/gson/JsonObject;->getAsJsonArray(Ljava/lang/String;)Lcom/google/gson/JsonArray;

    move-result-object v0

    iget-object v1, p0, Lcom/mobile/indiapp/n/ba;->a:Lcom/google/gson/Gson;

    new-instance v2, Lcom/mobile/indiapp/n/ba$1;

    invoke-direct {v2, p0}, Lcom/mobile/indiapp/n/ba$1;-><init>(Lcom/mobile/indiapp/n/ba;)V

    invoke-virtual {v2}, Lcom/mobile/indiapp/n/ba$1;->getType()Ljava/lang/reflect/Type;
...
.method protected synthetic b(Lb/z;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/mobile/indiapp/n/ba;->a(Lb/z;Ljava/lang/String;)Ljava/util/List;

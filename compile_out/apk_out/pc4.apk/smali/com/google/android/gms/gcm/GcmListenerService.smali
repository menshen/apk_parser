...
.method private a(Landroid/content/Intent;)V
    ...
    invoke-static {v0}, Lcom/google/android/gms/gcm/GcmListenerService;->b(Landroid/os/Bundle;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p0, p1}, Lcom/google/android/gms/gcm/b;->b(Landroid/content/Context;Landroid/content/Intent;)V
...
.method private b()V
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/gcm/GcmListenerService;->a(I)Z
...
.method private c(Landroid/content/Intent;)V
    ...
    :cond_1
    :goto_1
    invoke-direct {p0}, Lcom/google/android/gms/gcm/GcmListenerService;->b()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {p0, p1}, Lcom/google/android/gms/gcm/b;->c(Landroid/content/Context;Landroid/content/Intent;)V
    :try_end_2
...
.method private d(Landroid/content/Intent;)V
    ...
    invoke-static {p0, p1}, Lcom/google/android/gms/gcm/b;->a(Landroid/content/Context;Landroid/content/Intent;)V
...
.method private e(Landroid/content/Intent;)V
    ...
    invoke-static {v0}, Lcom/google/android/gms/gcm/c;->a(Landroid/os/Bundle;)Z

    move-result v1

    if-eqz v1, :cond_2

    invoke-static {p0}, Lcom/google/android/gms/gcm/c;->a(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v1}, Lcom/google/android/gms/gcm/c;->a(Landroid/content/Context;Ljava/lang/Class;)Lcom/google/android/gms/gcm/c;

    move-result-object v1

    invoke-virtual {v1, v0}, Lcom/google/android/gms/gcm/c;->c(Landroid/os/Bundle;)Z
    ...
    invoke-static {v1}, Lcom/google/android/gms/gcm/GcmListenerService;->b(Landroid/os/Bundle;)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-static {p0, p1}, Lcom/google/android/gms/gcm/b;->d(Landroid/content/Context;Landroid/content/Intent;)V

    :cond_1
    invoke-static {v0}, Lcom/google/android/gms/gcm/c;->b(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/google/android/gms/gcm/GcmListenerService;->a(Ljava/lang/String;Landroid/os/Bundle;)V

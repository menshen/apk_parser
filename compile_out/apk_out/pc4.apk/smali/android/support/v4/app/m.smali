...
.field p:Landroid/support/v4/app/i;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/app/m;->r:Ljava/lang/reflect/Field;
...
.method private a(Ljava/lang/RuntimeException;)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/m;->o:Landroid/support/v4/app/k;
    ...
    invoke-virtual {v0, v2, v3, v1, v4}, Landroid/support/v4/app/k;->a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    :try_end_0
...
.method static a(Landroid/view/View;Landroid/view/animation/Animation;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/view/ab;->g(Landroid/view/View;)I

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p0}, Landroid/support/v4/view/ab;->v(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p1}, Landroid/support/v4/app/m;->a(Landroid/view/animation/Animation;)Z
...
.method private b(Landroid/view/View;Landroid/view/animation/Animation;)V
    ...
    :cond_1
    invoke-static {p1, p2}, Landroid/support/v4/app/m;->a(Landroid/view/View;Landroid/view/animation/Animation;)Z
    ...
    :try_start_0
    sget-object v0, Landroid/support/v4/app/m;->r:Ljava/lang/reflect/Field;
    ...
    invoke-direct {v1, p1, p2, v0}, Landroid/support/v4/app/m$a;-><init>(Landroid/view/View;Landroid/view/animation/Animation;Landroid/view/animation/Animation$AnimationListener;)V
...
.method public a(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment$SavedState;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/app/m;->g(Landroid/support/v4/app/Fragment;)Landroid/os/Bundle;
...
.method public a(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    sget-object v1, Landroid/support/v4/app/m$b;->a:[I
    ...
    invoke-virtual {p0, v7}, Landroid/support/v4/app/m;->a(I)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {p0, v8}, Landroid/support/v4/app/m;->a(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {p0, v1}, Landroid/support/v4/app/m;->a(I)Landroid/support/v4/app/Fragment;
    ...
    iput-object p0, v4, Landroid/support/v4/app/Fragment;->B:Landroid/support/v4/app/m;

    iget-object v0, p0, Landroid/support/v4/app/m;->o:Landroid/support/v4/app/k;

    iput-object v0, v4, Landroid/support/v4/app/Fragment;->C:Landroid/support/v4/app/k;
    ...
    iget-object v1, p0, Landroid/support/v4/app/m;->o:Landroid/support/v4/app/k;

    iput-object v1, v0, Landroid/support/v4/app/Fragment;->C:Landroid/support/v4/app/k;
    ...
    :cond_c
    invoke-virtual {p0, v1}, Landroid/support/v4/app/m;->c(Landroid/support/v4/app/Fragment;)V
...
.method public a(II)V
    ...
    invoke-direct {v0, p0, p1, p2}, Landroid/support/v4/app/m$2;-><init>(Landroid/support/v4/app/m;II)V
...
.method a(IIIZ)V
    ...
    iget-object v0, v1, Landroid/support/v4/app/Fragment;->V:Landroid/support/v4/app/s;
    ...
    iput-boolean v5, p0, Landroid/support/v4/app/m;->s:Z
...
.method a(Landroid/os/Parcelable;Ljava/util/List;)V
    ...
    iget-object v5, p0, Landroid/support/v4/app/m;->o:Landroid/support/v4/app/k;

    invoke-virtual {v5}, Landroid/support/v4/app/k;->g()Landroid/content/Context;
    ...
    iget-object v3, p0, Landroid/support/v4/app/m;->o:Landroid/support/v4/app/k;

    iget-object v4, p0, Landroid/support/v4/app/m;->q:Landroid/support/v4/app/Fragment;

    invoke-virtual {v1, v3, v4}, Landroid/support/v4/app/FragmentState;->instantiate(Landroid/support/v4/app/k;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {v1, p0}, Landroid/support/v4/app/BackStackState;->instantiate(Landroid/support/v4/app/m;)Landroid/support/v4/app/d;
    ...
    invoke-virtual {p0, v3, v1}, Landroid/support/v4/app/m;->a(ILandroid/support/v4/app/d;)V
...
.method a(Landroid/support/v4/app/Fragment;IIIZ)V
    ...
    iput-object v0, p1, Landroid/support/v4/app/Fragment;->C:Landroid/support/v4/app/k;
    ...
    :goto_2
    iput-object v0, p1, Landroid/support/v4/app/Fragment;->B:Landroid/support/v4/app/m;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/app/k;->b(Landroid/support/v4/app/Fragment;)V
    ...
    invoke-static {v0, v3}, Landroid/support/v4/view/ab;->a(Landroid/view/View;Z)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/m;->p:Landroid/support/v4/app/i;
    ...
    invoke-static {v1, v3}, Landroid/support/v4/view/ab;->a(Landroid/view/View;Z)V

    :goto_6
    if-eqz v0, :cond_14

    invoke-virtual {p0, p1, p3, v5, p4}, Landroid/support/v4/app/m;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    invoke-direct {p0, v2, v1}, Landroid/support/v4/app/m;->b(Landroid/view/View;Landroid/view/animation/Animation;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/app/k;->a(Landroid/support/v4/app/Fragment;)Z
    ...
    invoke-virtual {p0, p1, p3, v3, p4}, Landroid/support/v4/app/m;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    invoke-direct {v2, p0, v1, v0, p1}, Landroid/support/v4/app/m$3;-><init>(Landroid/support/v4/app/m;Landroid/view/View;Landroid/view/animation/Animation;Landroid/support/v4/app/Fragment;)V
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/Fragment;->f_()V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/app/m;->e(Landroid/support/v4/app/Fragment;)V

    goto/16 :goto_1

    :cond_31
    iput-object v7, p1, Landroid/support/v4/app/Fragment;->C:Landroid/support/v4/app/k;

    iput-object v7, p1, Landroid/support/v4/app/Fragment;->E:Landroid/support/v4/app/Fragment;

    iput-object v7, p1, Landroid/support/v4/app/Fragment;->B:Landroid/support/v4/app/m;

    iput-object v7, p1, Landroid/support/v4/app/Fragment;->D:Landroid/support/v4/app/m;
...
.method public a(Landroid/support/v4/app/Fragment;Z)V
    ...
    :cond_1
    invoke-virtual {p0, p1}, Landroid/support/v4/app/m;->d(Landroid/support/v4/app/Fragment;)V
...
.method public a(Landroid/support/v4/app/k;Landroid/support/v4/app/i;Landroid/support/v4/app/Fragment;)V
    ...
    :cond_0
    iput-object p1, p0, Landroid/support/v4/app/m;->o:Landroid/support/v4/app/k;

    iput-object p2, p0, Landroid/support/v4/app/m;->p:Landroid/support/v4/app/i;
...
.method public b(Landroid/support/v4/app/Fragment;II)V
    ...
    invoke-virtual {p0, p1, p2, v0, p3}, Landroid/support/v4/app/m;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    invoke-direct {p0, v1, v0}, Landroid/support/v4/app/m;->b(Landroid/view/View;Landroid/view/animation/Animation;)V
...
.method public c(Landroid/support/v4/app/Fragment;II)V
    ...
    invoke-virtual {p0, p1, p2, v4, p3}, Landroid/support/v4/app/m;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    iput-boolean v4, p0, Landroid/support/v4/app/m;->s:Z
...
.method public d(Landroid/support/v4/app/Fragment;II)V
    ...
    iput-boolean v2, p0, Landroid/support/v4/app/m;->s:Z
...
.method public e()Z
    ...
    invoke-virtual {v3}, Landroid/support/v4/app/k;->h()Landroid/os/Handler;
    ...
    iget-object v5, v0, Landroid/support/v4/app/Fragment;->V:Landroid/support/v4/app/s;

    if-eqz v5, :cond_3

    iget-object v0, v0, Landroid/support/v4/app/Fragment;->V:Landroid/support/v4/app/s;
    ...
    iput-boolean v2, p0, Landroid/support/v4/app/m;->w:Z
...
.method f()V
    ...
    invoke-interface {v0}, Landroid/support/v4/app/l$a;->a()V
...
.method h()Landroid/os/Parcelable;
    ...
    iput-boolean v1, p0, Landroid/support/v4/app/m;->t:Z
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/app/m;->g(Landroid/support/v4/app/Fragment;)Landroid/os/Bundle;
...
.method public r()V
    ...
    invoke-virtual {p0, v2, v2}, Landroid/support/v4/app/m;->a(IZ)V

    iput-object v1, p0, Landroid/support/v4/app/m;->o:Landroid/support/v4/app/k;

    iput-object v1, p0, Landroid/support/v4/app/m;->p:Landroid/support/v4/app/i;

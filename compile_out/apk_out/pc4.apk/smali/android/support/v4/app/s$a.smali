...
.method a()V
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/s$a;->d:Landroid/support/v4/content/e;
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/r$a;->a(ILandroid/os/Bundle;)Landroid/support/v4/content/e;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/s$a;->d:Landroid/support/v4/content/e;
    ...
    iget-object v2, p0, Landroid/support/v4/app/s$a;->d:Landroid/support/v4/content/e;
    ...
    invoke-virtual {v0, v1, p0}, Landroid/support/v4/content/e;->a(ILandroid/support/v4/content/e$b;)V

    iget-object v0, p0, Landroid/support/v4/app/s$a;->d:Landroid/support/v4/content/e;

    invoke-virtual {v0, p0}, Landroid/support/v4/content/e;->a(Landroid/support/v4/content/e$a;)V
...
.method a(Landroid/support/v4/content/e;Ljava/lang/Object;)V
    ...
    invoke-static {v1}, Landroid/support/v4/app/s;->a(Landroid/support/v4/app/s;)Landroid/support/v4/app/k;
    ...
    invoke-static {v0}, Landroid/support/v4/app/s;->a(Landroid/support/v4/app/s;)Landroid/support/v4/app/k;

    move-result-object v0

    iget-object v0, v0, Landroid/support/v4/app/k;->d:Landroid/support/v4/app/m;

    iget-object v0, v0, Landroid/support/v4/app/m;->v:Ljava/lang/String;
    ...
    iget-object v1, v1, Landroid/support/v4/app/k;->d:Landroid/support/v4/app/m;

    const-string/jumbo v2, "onLoadFinished"

    iput-object v2, v1, Landroid/support/v4/app/m;->v:Ljava/lang/String;
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/r$a;->a(Landroid/support/v4/content/e;Ljava/lang/Object;)V
    :try_end_0
    ...
    iput-object v1, v0, Landroid/support/v4/app/m;->v:Ljava/lang/String;
    ...
    invoke-static {v2}, Landroid/support/v4/app/s;->a(Landroid/support/v4/app/s;)Landroid/support/v4/app/k;
    ...
    iget-object v2, v2, Landroid/support/v4/app/k;->d:Landroid/support/v4/app/m;

    iput-object v1, v2, Landroid/support/v4/app/m;->v:Ljava/lang/String;
...
.method c()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/s$a;->a(Landroid/support/v4/content/e;Ljava/lang/Object;)V
...
.method e()V
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/content/e;->a(Landroid/support/v4/content/e$b;)V

    iget-object v0, p0, Landroid/support/v4/app/s$a;->d:Landroid/support/v4/content/e;

    invoke-virtual {v0, p0}, Landroid/support/v4/content/e;->b(Landroid/support/v4/content/e$a;)V
...
.method f()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/s$a;->d:Landroid/support/v4/content/e;
    ...
    iput-object v3, v1, Landroid/support/v4/app/m;->v:Ljava/lang/String;
    ...
    iget-object v3, p0, Landroid/support/v4/app/s$a;->d:Landroid/support/v4/content/e;

    invoke-interface {v0, v3}, Landroid/support/v4/app/r$a;->a(Landroid/support/v4/content/e;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

...
# instance fields
.field b:Landroid/support/v4/c/f$b;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field c:Landroid/support/v4/c/f$c;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/support/v4/c/f",
            "<TK;TV;>.c;"
...
.field d:Landroid/support/v4/c/f$e;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/support/v4/c/f",
            "<TK;TV;>.e;"
...
.method public d()Ljava/util/Set;
    ...
    iget-object v0, p0, Landroid/support/v4/c/f;->b:Landroid/support/v4/c/f$b;

    if-nez v0, :cond_0

    new-instance v0, Landroid/support/v4/c/f$b;

    invoke-direct {v0, p0}, Landroid/support/v4/c/f$b;-><init>(Landroid/support/v4/c/f;)V

    iput-object v0, p0, Landroid/support/v4/c/f;->b:Landroid/support/v4/c/f$b;
...
.method public e()Ljava/util/Set;
    ...
    iget-object v0, p0, Landroid/support/v4/c/f;->c:Landroid/support/v4/c/f$c;

    if-nez v0, :cond_0

    new-instance v0, Landroid/support/v4/c/f$c;

    invoke-direct {v0, p0}, Landroid/support/v4/c/f$c;-><init>(Landroid/support/v4/c/f;)V

    iput-object v0, p0, Landroid/support/v4/c/f;->c:Landroid/support/v4/c/f$c;
...
.method public f()Ljava/util/Collection;
    ...
    iget-object v0, p0, Landroid/support/v4/c/f;->d:Landroid/support/v4/c/f$e;

    if-nez v0, :cond_0

    new-instance v0, Landroid/support/v4/c/f$e;

    invoke-direct {v0, p0}, Landroid/support/v4/c/f$e;-><init>(Landroid/support/v4/c/f;)V

    iput-object v0, p0, Landroid/support/v4/c/f;->d:Landroid/support/v4/c/f$e;
